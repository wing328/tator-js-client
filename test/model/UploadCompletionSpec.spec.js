...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new Tator.UploadCompletionSpec();
  });
  ...
  describe('UploadCompletionSpec', function() {
    it('should create an instance of UploadCompletionSpec', function() {
      // uncomment below and update the code to test UploadCompletionSpec
      //var instance = new Tator.UploadCompletionSpec();
      //expect(instance).to.be.a(Tator.UploadCompletionSpec);
    });
