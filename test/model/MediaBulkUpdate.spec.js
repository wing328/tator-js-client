...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new Tator.MediaBulkUpdate();
  });
  ...
  describe('MediaBulkUpdate', function() {
    it('should create an instance of MediaBulkUpdate', function() {
      // uncomment below and update the code to test MediaBulkUpdate
      //var instance = new Tator.MediaBulkUpdate();
      //expect(instance).to.be.a(Tator.MediaBulkUpdate);
    });
