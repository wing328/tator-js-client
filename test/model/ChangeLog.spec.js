...
(function(root, factory) {
  ...
  describe('ChangeLog', function() {
    it('should create an instance of ChangeLog', function() {
      ...
      //var instance = new Tator.ChangeLog();
      //expect(instance).to.be.a(Tator.ChangeLog);
    });
    ...
    it('should have the property descriptionOfChange (base name: "description_of_change")', function() {
      // uncomment below and update the code to test the property descriptionOfChange
      //var instance = new Tator.ChangeLog();
      //expect(instance).to.be();
    });
