...
(function(root, factory) {
  ...
  describe('UploadInfo', function() {
    it('should create an instance of UploadInfo', function() {
      // uncomment below and update the code to test UploadInfo
      //var instance = new Tator.UploadInfo();
      //expect(instance).to.be.a(Tator.UploadInfo);
    });
