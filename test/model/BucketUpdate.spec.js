...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new Tator.BucketUpdate();
  });
  ...
  describe('BucketUpdate', function() {
    it('should create an instance of BucketUpdate', function() {
      // uncomment below and update the code to test BucketUpdate
      //var instance = new Tator.BucketUpdate();
      //expect(instance).to.be.a(Tator.BucketUpdate);
    });
