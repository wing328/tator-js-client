...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new Tator.StateBulkUpdate();
  });
  ...
  describe('StateBulkUpdate', function() {
    it('should create an instance of StateBulkUpdate', function() {
      // uncomment below and update the code to test StateBulkUpdate
      //var instance = new Tator.StateBulkUpdate();
      //expect(instance).to.be.a(Tator.StateBulkUpdate);
    });
