...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new Tator.LeafBulkUpdate();
  });
  ...
  describe('LeafBulkUpdate', function() {
    it('should create an instance of LeafBulkUpdate', function() {
      // uncomment below and update the code to test LeafBulkUpdate
      //var instance = new Tator.LeafBulkUpdate();
      //expect(instance).to.be.a(Tator.LeafBulkUpdate);
    });
