...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new Tator.GenericFile();
  });
  ...
  describe('GenericFile', function() {
    it('should create an instance of GenericFile', function() {
      // uncomment below and update the code to test GenericFile
      //var instance = new Tator.GenericFile();
      //expect(instance).to.be.a(Tator.GenericFile);
    });
